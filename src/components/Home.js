...
import ProfilePic from '../Assets/deekshith.jpeg';
    ...
    <div className="home-page">
        <div className="container">
            <div className="text-column">
                ...
                <p className="intro-text">
                    I'M <strong className="anime-effect">Deekshith Gunda</strong>
                </p>
        ...
        <div className="social-icons">
            ...
            <ul className="connect-icons">
                <li>
                    <a href="https://github.com/deekshithgunda7" target="_blank" rel="noopener noreferrer">
                        <FaGithub className="contact-icon" size={30}/>
                    </a>
                </li>
                <li>
                    <a href="https://www.linkedin.com/in/deekshith-g-61171a184/" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                    <a href="mailto:deekshithduke356@gmail.com" target="_blank" rel="noopener noreferrer">
